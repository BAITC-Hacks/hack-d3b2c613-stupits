"""Архив интерфейса: python -m streamlit run legacy/app.py."""
...
from legacy.ui.components import district_name, effect_text, number, render_map, render_profile, render_results
from legacy.ui.advisor_panel import render_advisor, render_auto_analysis
from legacy.ui.engine_adapter import AdapterError, EngineAdapter, EngineUnavailable, ROOT
